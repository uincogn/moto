...
class BackupService {
  //static const String _backupFileName = 'motouber_backup'; // Remove unused field
  ...
  // static Future<void> _restoreData(Map<String, dynamic> data) async { // Remove unused element

  //   final db = DatabaseService.instance;

  //   // Backup dos dados atuais antes de restaurar
  //   await createBackup();
  ...
  //     // Restaurar trabalhos
  //     if (data['trabalhos'] != null) {
  //       for (final item in data['trabalhos']) {
  //         await db.insertTrabalho(item);
  //       }
  //     }

  //     // Restaurar gastos
  //     if (data['gastos'] != null) {
  //       for (final item in data['gastos']) {
  //         await db.insertGasto(item);
  //       }
  //     }

  //     // Restaurar manutenções
  //     if (data['manutencoes'] != null) {
  //       for (final item in data['manutencoes']) {
  //         await db.insertManutencao(item);
  //       }
  //     }
  //   } catch (e) {
  //     throw Exception('Erro durante restauração: $e');
  //   }
  // }
...
```analysis
The code removes the unused private field `_backupFileName` and the unused private method `_restoreData` from the `BackupService` class to resolve the Flutter analyzer warnings and prevent the Codemagic build from failing.
```
...
class BackupService {
  //static const String _backupFileName = 'motouber_backup';
...
class BackupService {
  ...
  //   //   throw Exception('Erro durante restauração: $e');
  //   // }
  //   // Função de restauração temporariamente desabilitada
  //   print('Dados seriam restaurados aqui');
  // }
}